...
data1 = pd.read_csv(
    "C:\\Users\\User\\PycharmProjects\\ml-pipeline\\kedro_ml_pipeline_dir\\src\\rest_service\\csv_dataset\\Sentiment"
    ".csv")
...
def predict(sentiment_request: ModelPredictionRequest):
    ...
    loaded_model = tf.keras.models.load_model("C:\\Users\\User\\PycharmProjects\\ml-pipeline\\kedro_ml_pipeline_dir"
                                              "\\src\\rest_service\\saved_model\\sentiment.h5")
